Table S12. Integrity screens. Six deterministic screens over the corpus, each
...
Inputs shipped for this table:
  ...
  ../../published_data/reference/cellosaurus_repaired.sqlite   (carries organism and
...
Run:
  PYTHONPATH=. AGE_MODULE=./age_composition.py python3 verify_screens.py \
    ../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz \
    ../../published_data/reference/mesh.sqlite ../../published_data/reference/cellosaurus_repaired.sqlite \
    ./evidence <out_dir>
