Table S7. GSE-context short-form expansion audit. Each per-study acronym
...
Substitute them exactly as written, then run `python3 phase2_gse_shortform_eval.py`.
  ...
  GSEM = "Directory to gse_meta_scraped.json.gz"
      -> ../../published_data/data/01_input_metadata/gse_meta_scraped.json.gz
...
geo_metadata.sqlite is not shipped; build it first from the metadata that is:
    python3 ../../published_data/data/01_input_metadata/build_geo_metadata.py
