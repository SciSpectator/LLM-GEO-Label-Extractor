Table S8 - effect of the final case-fold step
==============================================
...
---
    python3 casefold_effect.py \
        ../../published_data/data/06_final_labels_repaired/phase2_out/dictionary_prefold.json.gz \
        ../../published_data/data/06_final_labels_repaired/phase2_out/dictionary.json.gz \
        casefold_effect.csv
...
These are the numbers Table S8 and the Results report, and they come from the
repaired corpus named under Inputs below. Passing the first-pass dictionaries in
../../published_data/data/04_phase2_output instead gives 749/336/23,477/28,036, which describes the
...
clause in the Table S8 caption refers to.

Inputs for the corpus this paper reports:
  Phase 2 output dir   ../../published_data/data/06_final_labels_repaired/phase2_out
  pre-fold dictionary  ../../published_data/data/06_final_labels_repaired/phase2_out/dictionary_prefold.json.gz
  post-fold dictionary ../../published_data/data/06_final_labels_repaired/phase2_out/dictionary.json.gz
  labels               ../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz
Pass these explicitly; the defaults in the script point at the first-pass output
kept in ../../published_data/data/04_phase2_output for provenance.
