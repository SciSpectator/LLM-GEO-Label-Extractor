...
def main():
    pre_path = sys.argv[1] if len(sys.argv) > 1 else "../S06_oov_consolidation/dictionary_prefold.json.gz"
    post_path = sys.argv[2] if len(sys.argv) > 2 else "../../published_data/data/06_final_labels_repaired/phase2_out/dictionary.json.gz"
