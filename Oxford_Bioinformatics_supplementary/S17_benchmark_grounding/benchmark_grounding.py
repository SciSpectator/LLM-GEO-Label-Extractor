...
import os as _os
PKG = _os.path.abspath(_os.path.join(_os.path.dirname(__file__), "..", "..", "published_data"))

GOLD = _os.path.abspath(_os.path.join(_os.path.dirname(__file__), "..", "S01_manual_benchmark"))

SRC = f"{PKG}/data/01_input_metadata/samples_804k.json.gz"
...
with (_gzip.open(SRC, "rt") if SRC.endswith(".gz") else open(SRC)) as fh:
