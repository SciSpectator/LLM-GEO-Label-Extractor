Table S2. Phase 1b recovery of "Not Specified" labels using GSE context.

Result file in this folder: phase1b_recovery.csv
Generating script in this folder: phase1b_recovery.py

Run (from this folder):
  python3 phase1b_recovery.py ../../published_data/data/02_phase1_1b_output \
...
GSE-context inference survives only in ../../published_data/data/02_phase1_1b_output, while the
label it ended up with is in the released corpus. Taking each column from the
file that holds it keeps the Phase 1b coverage identical to what the consolidated extraction-yield table
