the cross-field scope corrections table - cross-field scope: what was removed, what was moved, what it cost
=============================================================================
...
Run
---
    python3 field_scope_audit.py ../../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz field_scope_audit.csv
...
Passing ../../../published_data/data/05_final_labels/LLM_labels_all_samples.csv.gz instead reruns the
