the age-extraction error analysis / Table 1 Age row - age value composition
===================================================
...
Definitions
-----------
"Age labels extracted" (Table 1, Table S2) is every class except not_specified: 383,173,
...
number. The last two are the "spurious" rows of the age-extraction error analysis and are excluded from age
