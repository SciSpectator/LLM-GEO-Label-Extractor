...
Run
---
    python3 grounding_audit.py ../../../published_data/data/01_input_metadata/geo_metadata.sqlite \
        ../../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz grounding_audit.csv
...
shipped twice:
    cd ../../../published_data/data/01_input_metadata && python3 build_geo_metadata.py \
