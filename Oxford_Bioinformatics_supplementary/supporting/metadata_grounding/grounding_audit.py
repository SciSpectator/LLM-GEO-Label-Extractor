...
def main():
    meta_path = sys.argv[1] if len(sys.argv) > 1 else "../../../published_data/data/01_input_metadata/geo_metadata.sqlite"
    corpus_path = sys.argv[2] if len(sys.argv) > 2 else "../../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz"
