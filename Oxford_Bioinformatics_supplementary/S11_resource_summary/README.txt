Table S11 - what the released corpus contains
=============================================
...
---
    python3 resource_summary.py \
        ../../published_data/data/06_final_labels_repaired/LLM_labels_all_samples_FINAL.csv.gz resource_summary.csv
...
--------------------------------------------
the controlled-vocabulary normalization summary counts distinct raw values, the surface forms that enter normalization. This table
