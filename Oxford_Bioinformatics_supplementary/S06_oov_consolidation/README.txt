Table S6. Out-of-vocabulary (OOV) concept consolidation, measured after BioLORD + LLM
similarity consolidation and before the final case-fold step (Table S8). Per field, over the
...
Input in this folder:       dictionary_prefold.json.gz  (the pre-case-fold dictionary snapshot;
                            the released final dictionary in ../../published_data/data/04_phase2_output/ is post-fold,
