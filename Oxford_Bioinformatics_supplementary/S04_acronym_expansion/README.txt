Table S4. Bare disease-acronym -> MeSH expansion (Track B). Over samples whose bare label is a known disease acronym with GSE context available: resolved vs not_resolved, and the MeSH target when resolved.
...
Run:
  python3 acronym_gold_eval.py \
      ...
      ../../published_data/reference/mesh.sqlite phase2_evaluation.py acronym_expansion.csv
