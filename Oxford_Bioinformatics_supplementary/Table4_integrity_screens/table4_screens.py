...
``../S12_integrity_screens/verify_screens.py``, which is the code
...
Usage:
    PYTHONPATH=<S12_dir> AGE_MODULE=<S12_dir>/age_composition.py \
...
def main():
    ...
    # MeSH id is a staging failure, repaired separately and counted in Table S12.
    staging_driven = 0
    total = 0
